    ...
    <ul class="team__grid" role="list">
      ...
      <li class="team__card">
        ...
        eve=c_portrait(H, depth, 'Mrs Eve Sulo',
                       'images/brand/eve-botesdale-dental.png', (1200, 1554))))
...
# ---- Fees and membership -----------------------------------------------------
def r_fees(depth, H):
    """Laid out as a vertical narrative rather than two racing columns.

    This page used to be two `cols-2 grid--loose` sections, each with an
    unrelated h2 in either column, and the plan cards nested in a second
    two-column grid — so they got half of half the page and the price
    collided with its own unit. One idea per band now, each on the rail,
    with the reading passages held at the measure.
    """
    out = [c_page_head(
    ...
    # --- 1. How paying works — a passage, so it gets a column to itself ----
    out.append(c_section('''<div class="section-head">
      <span class="label">What it costs</span>
      <h2>We offer you a range of options when it comes to paying for your treatment.</h2>
    </div>
    <div class="prose">
      <ul>
    ...
    <div class="plan-row">
      <div class="plan plan--feature">
        ...
        <h3>Adults</h3>
        <div class="plan__price">£19.95<small>per month</small></div>
      </div>
      <div class="plan">
        <span class="label">Peace of mind for</span>
        <h3>Children</h3>
        <div class="plan__price">£8.40*<small>per month</small></div>
      </div>
    </div>
    ...
    out.append(c_statement(
        H, depth, 'What is your investment?',
        '£19.95 per month — that’s it.',
        'No frills or hidden extras. So, for just £19.95 per month, we will help you create '
